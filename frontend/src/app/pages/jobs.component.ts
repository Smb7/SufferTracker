...
export class JobsComponent implements OnInit {
  ...
  logoTone(name: string): string {
    const tones = ['orange', 'green', 'violet', 'yellow', 'warm'];
    let hash = 0;
