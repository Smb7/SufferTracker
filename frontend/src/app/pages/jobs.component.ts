...
export class JobsComponent implements OnInit {
  jobs: Job[] = []; rawText = ''; screenshot: File | null = null; captureMode: 'text' | 'screenshot' = 'text'; parsed: ParsedJob | null = null; parsing = false; showCapture = false; message = ''; search = ''; activeFilter = 'All'; filters = ['All', 'Waiting', 'Interview', 'Job offer', 'Rejected'];
