...
The admin sign-in map uses CARTO raster tiles. Request a free key at https://carto.com/basemaps/apikey and store it as the GitHub Actions secret `MAP_APIKEY` (or set it in `.env`).
